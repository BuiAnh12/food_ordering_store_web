...
test("TC02 - Login with wrong credentials", async ({ page }) => {
...
test("TC03 - Login with blocked account", async ({ page }) => {
...
test("TC04 - Login with pending account", async ({ page }) => {
...
test("TC05 - Staff tries to access owner-only page", async ({ page }) => {
...
test("TC06 - Owner accesses all pages", async ({ page }) => {
    await login(page, "buianh120403@gmail.com", "123");
    await page.waitForTimeout(1000);
