...
import { useCreateDishMutation } from "../../../redux/features/dish/dishApi";
import { useGetAllToppingQuery } from "../../../redux/features/topping/toppingApi";
import { useGetAllCategoriesQuery } from "../../../redux/features/category/categoryApi"; // Import category API
...
const CreateDish = () => {
    ...
    const { data: allCategoryData } = useGetAllCategoriesQuery({ storeId }); // Fetch categories
    ...
    const allCategories = allCategoryData?.data || [];
    ...
    const confirmSave = async () => {
        ...
        if (image && !image.startsWith("http")) {
            try {
                ...
                formData.append("file", fileInput.files[0]); // Use "file" instead of "image"
